...
const Menu = () => {
  ...
  return (
    <div className="bg-black w-[200px] z-10 flex flex-col items-start absolute top-12 right-6 md:right-32 rounded-md p-4 space-y-4 shadow-md shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      {!user && (
      ...
      {user && (
        <h3 className="text-white text-sm hover:text-gray-500 cursor-pointer">
          <Link to={"/myblogs/" + user._id}>My Posts</Link>
        </h3>
      )}
      {user && (
        <h3
